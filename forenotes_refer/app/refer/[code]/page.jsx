...
export default function ReferralLandingPage() {
        ...
        async function validateAndRedirect() {
            try {
                ...
                if (data.valid) {
                    ...
                    // Redirect to the main app's sign-up page (using NEXT_PUBLIC_MAIN_APP_URL if available, otherwise just relative path)
                    const mainAppUrl = process.env.NEXT_PUBLIC_MAIN_APP_URL || "";
                    setTimeout(() => {
                        window.location.href = `${mainAppUrl}/auth/sign-up?ref=${encodeURIComponent(code)}`;
                    }, 2000);
                } else {
                    setStatus("invalid");
                }
    ...
    const handleSignupAnyway = () => {
        const mainAppUrl = process.env.NEXT_PUBLIC_MAIN_APP_URL || "https://forenotes.com";
        window.location.href = `${mainAppUrl}/auth/sign-up`;
    };
                ...
                {status === "valid" && (
                    <>
                        ...
                        >
                            ...
                            you to join Forenotes. Sign up now to get started!
                        </p>
